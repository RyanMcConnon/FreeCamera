package com.ryanpm96.isometriccamera.event;

import com.mojang.blaze3d.platform.GlStateManager;
import com.ryanpm96.isometriccamera.IsometricCamera;
import com.ryanpm96.isometriccamera.init.InitKeyBindings;
import com.ryanpm96.isometriccamera.math.Vector4d;
import com.ryanpm96.isometriccamera.util.IsometricCameraHelper;
...
public class ClientEventHandler {
    private static boolean isIsometric = false;
    ...
    public static void onCameraSetup(EntityViewRenderEvent.CameraSetup event) {
        ...
        if (isIsometric) {
            ...
            if(mc.mouseHelper.isMiddleDown()){
                ...
                System.out.println("X:" + pan_dX);
                System.out.println("Z:" + pan_dZ);
            }
            ...
            do {
                ...
                camera_position = IsometricCameraHelper.getCameraPosition(camera_distance, pitch, yaw);
    ...
    public static void preRenderGameOverlay(RenderGameOverlayEvent.Pre event) {
        if (isIsometric && event.getType().equals(RenderGameOverlayEvent.ElementType.CROSSHAIRS)) {
            event.setCanceled(true);
        }
    }
    ...
    public static void onRenderPlayer(RenderPlayerEvent event){
        ...
        if(isIsometric && event.getPlayer().equals(Minecraft.getInstance().player) && playerPos.distanceTo(camPos)<min_distance){
            event.setCanceled(true);
        }
    }
