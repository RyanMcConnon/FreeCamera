package com.ryanpm96.isometriccamera.math;
...
public final class Matrix4d {
    ...
    public Matrix4d(com.ryanpm96.isometriccamera.math.Matrix4d matrixIn) {
    ...
    public boolean equals(Object p_equals_1_) {
        if (this == p_equals_1_) {
            ...
            com.ryanpm96.isometriccamera.math.Matrix4d matrix4f = (com.ryanpm96.isometriccamera.math.Matrix4d)p_equals_1_;
     ...
     */
    @OnlyIn(Dist.CLIENT)
    public void mul(com.ryanpm96.isometriccamera.math.Matrix4d matrix) {
    ...
    public void mul(Quaternion quaternion) {
        this.mul(new com.ryanpm96.isometriccamera.math.Matrix4d(quaternion));
    }
    ...
    @OnlyIn(Dist.CLIENT)
    public static com.ryanpm96.isometriccamera.math.Matrix4d perspective(double fov, double aspectRatio, double nearPlane, double farPlane) {
        double f = (double)(1.0D / Math.tan(fov * (double)((double)Math.PI / 180F) / 2.0D));
        com.ryanpm96.isometriccamera.math.Matrix4d matrix4f = new com.ryanpm96.isometriccamera.math.Matrix4d();
    ...
    @OnlyIn(Dist.CLIENT)
    public static com.ryanpm96.isometriccamera.math.Matrix4d orthographic(double width, double height, double nearPlane, double farPlane) {
        com.ryanpm96.isometriccamera.math.Matrix4d matrix4f = new com.ryanpm96.isometriccamera.math.Matrix4d();
    ...
    @OnlyIn(Dist.CLIENT)
    public com.ryanpm96.isometriccamera.math.Matrix4d copy() {
        return new com.ryanpm96.isometriccamera.math.Matrix4d(this);
    }

    @OnlyIn(Dist.CLIENT)
    public static com.ryanpm96.isometriccamera.math.Matrix4d makeScale(double p_226593_0_, double p_226593_1_, double p_226593_2_) {
        com.ryanpm96.isometriccamera.math.Matrix4d matrix4f = new com.ryanpm96.isometriccamera.math.Matrix4d();
    ...
    @OnlyIn(Dist.CLIENT)
    public static com.ryanpm96.isometriccamera.math.Matrix4d makeTranslate(double p_226599_0_, double p_226599_1_, double p_226599_2_) {
        com.ryanpm96.isometriccamera.math.Matrix4d matrix4f = new com.ryanpm96.isometriccamera.math.Matrix4d();
        matrix4f.m00 = 1.0F;
        matrix4f.m11 = 1.0F;
        matrix4f.m22 = 1.0F;
    ...
    public void set(com.ryanpm96.isometriccamera.math.Matrix4d mat) {
        this.m00 = mat.m00;
        this.m01 = mat.m01;
        this.m02 = mat.m02;
        this.m03 = mat.m03;
    ...
    public void add(com.ryanpm96.isometriccamera.math.Matrix4d other) {
        m00 += other.m00;
        m01 += other.m01;
        m02 += other.m02;
        m03 += other.m03;
    ...
    public void multiplyBackward(com.ryanpm96.isometriccamera.math.Matrix4d other) {
        com.ryanpm96.isometriccamera.math.Matrix4d copy = other.copy();
        copy.mul(this);
        this.set(copy);
    }
